...
@section('title', 'Maalem – Forgot Password')
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="text-center mb-6">
                <h1 class="text-xl font-bold text-gray-900 display-font">Forgot Password</h1>
                <p class="text-xs text-gray-500 mt-1 body-font">We'll help you recover access</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required autofocus class="input-field body-font" placeholder="your@email.com" />
                ...
                <div class="mt-4 text-center">
                    <a href="{{ route('login') }}" class="text-xs text-orange-600 font-semibold hover:underline body-font">
                        Back to Login
                    </a>
                </div>
            </form>
