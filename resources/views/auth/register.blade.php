...
<head>
  ...
  <style>
    ...
    .cell-10 {
      background-image: url('./images/Tapis\ Marocaine.jpeg');
    }

    .cell-11 {
      background-image: url('./images/Artisan\ Woman\ Weaving\ Traditional\ Moroccan\ Baskets.jpeg');
    }

    .cell-12 {
      background-image: url('./images/L’Artisanat\ Marocain\ _\ Un\ Héritage\ de\ Savoir-Faire\ Authentique.jpeg');
    }
...
<body class="relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div class="relative z-10 w-full max-w-7xl mx-auto px-6 flex items-center justify-between gap-12">
    ...
    <div class="card w-full max-w-xl rounded-2xl px-8 py-10">
      ...
      <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" placeholder="Full Name" required autofocus
              class="input-field w-full px-3.5 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-800 placeholder-gray-300 bg-white" />
        ...
        <div>
          ...
          <select name="role" required
            class="input-field w-full px-3.5 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-800 bg-white">
          ...
          <div>
            ...
            <div class="relative">
              <input id="password" name="password" type="password" placeholder="Create a password" required
                class="input-field w-full px-3.5 py-2.5 pr-10 rounded-lg border border-gray-200 text-sm text-gray-800 placeholder-gray-300 bg-white" />
        ...
        <!-- CTA -->
        <button type="submit"
          class="btn-primary w-full py-3 rounded-full text-white text-sm font-semibold tracking-wide mt-1">
          Get Started
        </button>
      ...
      <!-- Google SSO -->
      <button
        class="btn-google w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg bg-white text-sm font-medium text-gray-700">
