...
<body class="relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div class="relative z-10 w-full max-w-7xl mx-auto px-6 flex items-center justify-between gap-12">
    ...
    <!-- Log-in card -->
    <div class="card w-full max-w-lg rounded-2xl px-8 py-10">

      <!-- Header -->
      <div class="text-center mb-6">
        <h1 class="text-xl font-bold text-gray-900 mb-1">Welcome Back</h1>
        <p class="text-xs text-gray-400 tracking-wide">Please enter your details</p>
      </div>
      ...
      <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <div>
          ...
          <input type="email" name="email" value="{{ old('email') }}" placeholder="Email address" required autofocus autocomplete="username" class="input-field w-full px-3.5 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-800 placeholder-gray-300 bg-white" />
        ...
        <div>
          ...
          <div class="relative">
            <input id="password" name="password" type="password" placeholder="Enter your password" required autocomplete="current-password" class="input-field w-full px-3.5 py-2.5 pr-10 rounded-lg border border-gray-200 text-sm text-gray-800 placeholder-gray-300 bg-white" />
        ...
        <!-- CTA -->
        <button type="submit" class="btn-primary w-full py-3 rounded-full text-white text-sm font-semibold tracking-wide mt-4">
          Log in
        </button>
