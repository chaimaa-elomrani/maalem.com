    ...
    <div class="w-full max-w-7xl mx-auto flex items-center justify-between gap-12">
      ...
      <div class="hero-text hidden md:block flex-1 text-white max-w-xs">
        ...
        <h2 class="text-4xl leading-tight font-bold mb-4 display-font">
          Log in to<br/>access your<br/>dashboard
        </h2>
      ...
      <!-- Log-in card -->
      <div class="login-card w-full max-w-lg rounded-2xl px-8 py-10">
        <!-- Header -->
        <div class="text-center mb-6">
          <h1 class="text-xl font-bold text-gray-900 mb-1 display-font">Welcome Back</h1>
          <p class="text-xs text-gray-400 tracking-wide body-font">Please enter your details</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
          ...
          <div>
            ...
            <input type="email" name="email" value="{{ old('email') }}" placeholder="Email address" required autofocus autocomplete="username" class="input-field w-full px-3.5 py-2.5 rounded-lg border border-gray-200 text-sm text-gray-800 placeholder-gray-300 bg-white body-font" />
          ...
          <div>
            ...
            <div class="relative">
              <input id="password" name="password" type="password" placeholder="Enter your password" required autocomplete="current-password" class="input-field w-full px-3.5 py-2.5 pr-10 rounded-lg border border-gray-200 text-sm text-gray-800 placeholder-gray-300 bg-white body-font" />
          ...
          <div class="flex items-center justify-between mt-4 body-font">
              ...
              @if (Route::has('password.request'))
                  <a class="text-xs text-orange-600 font-semibold hover:underline" href="{{ route('password.request') }}">
          ...
          <!-- CTA -->
          <button type="submit" class="btn-auth-submit w-full py-3 rounded-full text-white text-sm font-semibold tracking-wide mt-4 body-font">
            Log in
          </button>
        </form>
        ...
        <!-- Google SSO -->
        <button class="btn-google-auth w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg bg-white text-sm font-medium text-gray-700 body-font">
        ...
        <!-- Footer Sign Up Link -->
        <p class="text-center text-xs text-gray-500 mt-4 body-font">
          Don't have an account?
          <a href="{{ route('register') }}" class="text-orange-600 font-semibold hover:underline ml-1">Sign up</a>
        </p>
      </div>
    </div>
  </div>
